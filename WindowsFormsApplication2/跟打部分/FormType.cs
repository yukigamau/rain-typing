...
namespace WindowsFormsApplication2
{
	public partial class Form1 : NewForm
	{
		...
		private void Add_chartSpeed()
		{
			...
			this.chartSpeed.BackColor = System.Drawing.Color.FromArgb(
				((int)(((byte)(150)))), ((int)(((byte)(150)))), ((int)(((byte)(150)))));
			this.chartSpeed.BackSecondaryColor = System.Drawing.Color.FromArgb(
		...
		private void picBar_Draw(double pro, string text)
		{
			...
			g.DrawString(text, F, new SolidBrush(Theme.GetTranColor(Theme.SecondFC, 120)),
				this.picBar.Width / 2 - fontWidth / 2, this.picBar.Height / 2 - s.Height / 2 + 1);
