...
namespace WindowsFormsApplication2
{
    public partial class Form1 : NewForm
    {
        ...
        public void GetTheme()
        {
            ...
            // 太小了，换掉
            Theme.Font_2=(Font)fc.ConvertFromString(themeConf.IniReadValue("外观", "跟打区字体", "宋体, 17pt"));
        ...
        private void 打开练习ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (this.openFileDialog1.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("文件内容为空！", "雨雨跟打器载文提示");
                }
            }
        }
        #endregion
        ...
        private void 检验真伪ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show(this, "请检查是否为成绩？", "雨雨跟打器检验真伪提示");
                }
            }
            catch (Exception err)
            {
        ...
        private void Shortcut()
        {
            ...
            FileInfo fileStartup = new FileInfo(startupPath + "\\雨雨跟打器.lnk");

            FileInfo fileDesktop = new FileInfo(desktopPath + "\\雨雨跟打器.lnk");
            if (!fileDesktop.Exists)
            {
                ShortcutHelper.CreateShortcut(
                    Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\\雨雨跟打器.lnk",
            ...
            /*
              if (!fileStartup.Exists)
               {
                    //获取可执行文件快捷方式的全部路径
                    string exeDir = desktopPath + "\\雨雨跟打器.lnk";
                    //把程序快捷方式复制到启动目录
                     System.IO.File.Copy(exeDir, startupPath + "\\雨雨跟打器.lnk", true);
               }*/
        }
        #endregion
